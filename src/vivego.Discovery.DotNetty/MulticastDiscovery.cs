...
{
	public class MulticastDiscoverClientFactory : IDiscoverClientFactory
	{
		...
		public MulticastDiscoverClientFactory(
			string group = "Default",
			int disconveryServerPort = DiscoverMulticastServer.DefaultServerPort,
			...
			AddressFamily addressFamily = AddressFamily.InterNetwork)
		{
			...
			_multicastAddress = multicastAddress ?? DiscoverMulticastServer.DefaultMulticastAddress(addressFamily);
