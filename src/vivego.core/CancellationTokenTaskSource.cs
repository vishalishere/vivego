...
{
	/// <summary>
	///     Holds the task for a cancellation token, as well as the token registration. The registration is disposed when this
	...
	public sealed class CancellationTokenTaskSource<T> : IDisposable
	{
		...
		/// <summary>
		///     Disposes the cancellation token registration, if any. Note that this may cause <see cref="Task" /> to never
		///     complete.
		/// </summary>
		public void Dispose()
		{
